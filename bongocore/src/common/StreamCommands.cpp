...
std::optional<TKey> TPutStreamCommand::GetKey() { return std::make_optional(Key); }

std::optional<TKey> TPutStreamCommand::ExtractKey() { return std::make_optional(std::move(Key)); }

std::optional<TValue> TPutStreamCommand::GetValue() { return std::make_optional(Value); }
...
std::optional<TKey> TRemoveStreamCommand::GetKey() { return std::make_optional(Key); }
